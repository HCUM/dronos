...
namespace Valve.VR
{
    ...
    public class SteamVR_Behaviour_Single : MonoBehaviour
    {
        ...
        private void ActionChanged(SteamVR_Action_Single changedAction, SteamVR_Input_Sources changedSource, float newValue)
        {
            if (onChange != null)
            {
    ...
    [Serializable]
    public class SteamVR_Behaviour_SingleEvent : UnityEvent<SteamVR_Action_Single, SteamVR_Input_Sources, float> { }
}
...
namespace Valve.VR
{
    ...
    public class SteamVR_Behaviour_Vector2 : MonoBehaviour
    {
        ...
        private void ActionChanged(SteamVR_Action_Vector2 changedAction, SteamVR_Input_Sources changedSource, Vector2 newValue)
        {
            if (onChange != null)
            {
                onChange.Invoke(changedAction, changedSource, newValue);
            }
        }
    }

    [Serializable]
    public class SteamVR_Behaviour_Vector2Event : UnityEvent<SteamVR_Action_Vector2, SteamVR_Input_Sources, Vector2> { }
}
...
namespace Valve.VR
{
    public class SteamVR_Behaviour_Vector3 : MonoBehaviour
    {
        ...
        private void ActionChanged(SteamVR_Action_Vector3 changedAction, SteamVR_Input_Sources changedSource, Vector3 newValue)
        {
            if (onChange != null)
            {
    ...
    [Serializable]
    public class SteamVR_Behaviour_Vector3Event : UnityEvent<SteamVR_Action_Vector3, SteamVR_Input_Sources, Vector3> { }
}
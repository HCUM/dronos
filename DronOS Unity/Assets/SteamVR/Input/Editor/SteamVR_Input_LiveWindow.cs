        ...
        private void OnGUI()
        {
            ...
            for (int sourceIndex = 0; sourceIndex < sources.Length; sourceIndex++)
            {
                ...
                for (int actionSetIndex = 0; actionSetIndex < actionSets.Length; actionSetIndex++)
                {
                    ...
                    string activeText = set.IsActive(source) ? "Active" : "Inactive";
                    ...
                    for (int actionIndex = 0; actionIndex < set.allActions.Length; actionIndex++)
                    {
                        ...
                        if (action.actionSet == null || action.actionSet.IsActive(source) == false)
                        {
                        ...
                        if (action is ISteamVR_Action_In && ((ISteamVR_Action_In)action).GetActive(source) == false)
                        {

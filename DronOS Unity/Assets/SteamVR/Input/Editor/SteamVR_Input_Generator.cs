    ...
    public static class SteamVR_Input_Generator
    {
        ...
        public static void BeginGeneration()
        {
            ...
            if (string.IsNullOrEmpty(EditorSceneManager.GetActiveScene().path) == false)
                EditorSceneManager.OpenScene(EditorSceneManager.GetActiveScene().path); //reload open scene to avoid any weird serialization
        ...
        private static void GenerationStep_CreateInitClass()
        {
            ...
            CodeMemberMethod preinitMethod = CreateStaticMethod(inputClass, preinitializeMethodName);


            AddStaticInvokeToMethod(preinitMethod, startPreInitActionSetsMethodName);
            AddStaticInvokeToMethod(preinitMethod, initializeActionSetDictionariesMethodName);
            AddStaticInvokeToMethod(preinitMethod, preInitActionsMethodName);
            AddStaticInvokeToMethod(preinitMethod, initializeActionsArraysMethodName);
            AddStaticInvokeToMethod(preinitMethod, initializeActionDictionariesMethodName);
            AddStaticInvokeToMethod(preinitMethod, finishPreInitActionSetsMethodName);

            CodeMemberMethod constructor = CreateStaticConstructorMethod(inputClass);

            AddStaticInvokeToMethod(constructor, preinitializeMethodName);
        ...
        private const string preinitializeMethodName = "PreInitialize";
        private const string initializeActionDictionariesMethodName = "InitializeActionDictionaries";
        private const string initializeActionSetDictionariesMethodName = "InitializeActionSetDictionaries";
        ...
        private static void GenerateActionHelpers(string actionsClassFileName)
        {
            ...
            CodeMemberMethod actionsArraysInitMethod = CreateStaticMethod(inputClass, initializeActionsArraysMethodName);
            CodeMemberMethod actionsPreInitMethod = CreateStaticMethod(inputClass, preInitActionsMethodName);
            ...
            for (int actionIndex = 0; actionIndex < SteamVR_Input.actionFile.actions.Count; actionIndex++)
            {
                ...
                CodeMemberField actionField = CreateFieldAndPropertyWrapper(inputClass, action.codeFriendlyName, typeName);

                AddAssignActionStatement(actionsPreInitMethod, actionField.Name, action.name, typeName);
        ...
        private const string finishPreInitActionSetsMethodName = "FinishPreInitActionSets";
        ...
        private static void GenerateActionSetsHelpers(string actionSetsClassFileName)
        {
            ...
            CodeMemberMethod startPreInitActionSetsMethod = CreateStaticMethod(inputClass, startPreInitActionSetsMethodName);
            ...
            for (int actionSetIndex = 0; actionSetIndex < SteamVR_Input.actionFile.action_sets.Count; actionSetIndex++)
            {
                ...
                AddAssignActionSetStatement(startPreInitActionSetsMethod, actionSetField.Name, actionSet.name, setTypeName);
        ...
        private static CodeTypeDeclaration CreateActionSetClass(SteamVR_Input_ActionFile_ActionSet set)
        {
            ...
            foreach (var inAction in set.actionsInList)
            {
                ...
                CreateActionPropertyWrapper(setClass, inActionName, inAction);
            }
            ...
            foreach (var outAction in set.actionsOutList)
            {
                ...
                CreateActionPropertyWrapper(setClass, outActionName, outAction);
            }
        ...
        private static CodeMemberProperty CreateStaticProperty(CodeTypeDeclaration inputClass, string propertyName, string propertyType, CodeMemberField privateField)
        {
            ...
            CodeFieldReferenceExpression fieldReference = new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(typeof(SteamVR_Input)), privateField.Name);
        ...
        private static CodeMemberProperty CreateActionPropertyWrapper(CodeTypeDeclaration addToClass, string propertyName, SteamVR_Input_ActionFile_Action action)
        {
            ...
            CodeFieldReferenceExpression fieldReference = new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(typeof(SteamVR_Input)), action.codeFriendlyName);
        ...
        private static CodeMethodInvokeExpression AddStaticInvokeToMethod(CodeMemberMethod methodToAddTo, string invokeMethodName)
        {
            CodeMethodInvokeExpression invokeMethod = new CodeMethodInvokeExpression(new CodeMethodReferenceExpression(
                new CodeTypeReferenceExpression(typeof(SteamVR_Input).Name), invokeMethodName));
        ...
        private static void AddAssignActionStatement(CodeMemberMethod methodToAddTo, string fieldToAssign, string actionPath, string actionType)
        {

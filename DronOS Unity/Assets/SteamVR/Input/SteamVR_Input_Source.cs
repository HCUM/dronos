...
namespace Valve.VR
{
    public static class SteamVR_Input_Source
    {
        ...
        private static ulong[] updateSourceHandles;
        private static List<SteamVR_Input_Sources> updateSourcesList = new List<SteamVR_Input_Sources>(updateSources);
        ...
        public static ulong[] GetUpdateSourceHandles()
        {
            return updateSourceHandles;
        }

        public static bool AddSourceToUpdateList(SteamVR_Input_Sources newSource)
        {
            for (int updateSourceIndex = 0; updateSourceIndex < updateSources.Length; updateSourceIndex++)
            {
                if (updateSources[updateSourceIndex] == newSource)
                    return false;
            }

            updateSourcesList.Add(newSource);
            updateSources = updateSourcesList.ToArray();
            return true;
        }

        public static bool RemoveSourceFromUpdateList(SteamVR_Input_Sources removeSource)
        {
            if (updateSourcesList.Contains(removeSource) == false)
            {
                updateSourcesList.Remove(removeSource);
                updateSources = updateSourcesList.ToArray();
                return true;
            }
            return false;
        ...
        public static bool IsUpdatingSource(SteamVR_Input_Sources checkSource)
        {
            return updateSourcesList.Contains(checkSource);
        }
        ...
        public static void Initialize()
        {
            ...
            updateSourceHandles = inputSourceSourcesByHandle.Keys.ToArray();

...
namespace Valve.VR.InteractionSystem.Sample
{
    public class JoeJeffController : MonoBehaviour
    {
        ...
        public SteamVR_Action_Vector2 a_move = SteamVR_Input.GetAction<SteamVR_Action_Vector2>("platformer", "Move");
        public SteamVR_Action_Boolean a_jump = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("platformer", "Jump");

...
namespace Valve.VR.InteractionSystem
{
	...
	public class ControllerButtonHints : MonoBehaviour
	{
		...
		private Dictionary<ISteamVR_Action_In, ActionHintInfo> actionHintInfos;
        ...
        private IEnumerator DoInitialize(SteamVR_RenderModel renderModel)
        {
            ...
            actionHintInfos = new Dictionary<ISteamVR_Action_In, ActionHintInfo>();

            for (int actionIndex = 0; actionIndex < SteamVR_Input.actionsNonPoseNonSkeletonIn.Length; actionIndex++)
            {
                ISteamVR_Action_In action = (ISteamVR_Action_In)SteamVR_Input.actionsNonPoseNonSkeletonIn[actionIndex];
		...
		//-------------------------------------------------
		private void ShowButtonHint( params ISteamVR_Action_In[] actions )
		{
			renderModel.gameObject.SetActive( true );
		...
		//-------------------------------------------------
		private void HideButtonHint( params ISteamVR_Action_In[] actions )
		{
		...
		//-------------------------------------------------
		private bool IsButtonHintActive(ISteamVR_Action_In action )
		{
		...
		//-------------------------------------------------
		private void ShowText(ISteamVR_Action_In action, string text, bool highlightButton = true )
        {
            if ( actionHintInfos.ContainsKey(action) )
            {
                ActionHintInfo hintInfo = actionHintInfos[action];
		...
		//-------------------------------------------------
		private void HideText(ISteamVR_Action_In action)
		{
			if ( actionHintInfos.ContainsKey(action) )
			{
				ActionHintInfo hintInfo = actionHintInfos[action];
		...
		//-------------------------------------------------
		private string GetActiveHintText(ISteamVR_Action_In action )
		{
			if ( actionHintInfos.ContainsKey(action) )
			{
				ActionHintInfo hintInfo = actionHintInfos[action];
		...
		//-------------------------------------------------
		public static void ShowButtonHint( Hand hand, params ISteamVR_Action_In[] actions )
		{
		...
		//-------------------------------------------------
		public static void HideButtonHint( Hand hand, params ISteamVR_Action_In[] actions )
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static bool IsButtonHintActive( Hand hand, ISteamVR_Action_In action )
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static void ShowTextHint( Hand hand, ISteamVR_Action_In action, string text, bool highlightButton = true )
        {
            ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static void HideTextHint( Hand hand, ISteamVR_Action_In action)
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static string GetActiveHintText( Hand hand, ISteamVR_Action_In action)
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{

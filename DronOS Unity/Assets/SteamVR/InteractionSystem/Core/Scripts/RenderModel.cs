...
namespace Valve.VR.InteractionSystem
{
    public class RenderModel : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            {
                handSkeleton.skeletonAction.RemoveOnActiveChangeListener(handSkeleton.inputSource, OnSkeletonActiveChange);
                handSkeleton.skeletonAction.AddOnActiveChangeListener(handSkeleton.inputSource, OnSkeletonActiveChange); //watch for if it gets activated later
                DestroyHand();
            }
        }
        ...
        protected virtual void OnSkeletonActiveChange(SteamVR_Action_Skeleton changedAction, SteamVR_Input_Sources changedSource, bool newState)
        {
            if (newState)
            {
                InitializeHand();

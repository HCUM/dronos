...
namespace Valve.VR
{
    public class SteamVR : System.IDisposable
    {
        ...
        static void ReportError(EVRInitError error)
        {
            switch (error)
            {
                ...
                case EVRInitError.VendorSpecific_UnableToConnectToOculusRuntime:
                    Debug.Log("<b>[SteamVR]</b> Initialization Failed!  Make sure device is on, Oculus runtime is installed, and OVRService_*.exe is running.");
                    break;
                case EVRInitError.Init_VRClientDLLNotFound:
                    Debug.Log("<b>[SteamVR]</b> Drivers not found!  They can be installed via Steam under Library > Tools.  Visit http://steampowered.com to install Steam.");
                    break;
                case EVRInitError.Driver_RuntimeOutOfDate:
                    Debug.Log("<b>[SteamVR]</b> Initialization Failed!  Make sure device's runtime is up to date.");
                    break;
                default:
                    Debug.Log("<b>[SteamVR]</b> " + OpenVR.GetStringForHmdError(error));
                    break;
            }
        }
        ...
        public static void ShowBindingsForEditor()
        {
            ...
            {
                Debug.LogError("<b>[SteamVR]</b> Error showing bindings ui: " + showBindingsError.ToString());
            }
            */
            ...
            Application.OpenURL("http://localhost:8998/dashboard/controllerbinding.html?app=" + SteamVR_Settings.instance.editorAppKey); //todo: update with the actual call
        }
        ...
        private static void IdentifyEditorApplication()
        {
